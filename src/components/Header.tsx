...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed left-0 right-0 top-0 z-50 bg-primary/95 backdrop-blur-md">
        ...
        {/* Mobile Navigation */}
        <div
          className={`overflow-hidden border-t border-primary-foreground/10 bg-primary transition-all duration-300 ease-in-out md:hidden ${
        ...
        <div className="relative">
          ...
          <div className="h-0.5 bg-gradient-to-r from-primary-foreground/20 via-primary-foreground/40 to-primary-foreground/20" />
        </div>
      </header>
    </>
  );
